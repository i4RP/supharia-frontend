...
## 連携知識の利用
1. API/バックエンド連携の作業では、`.claude/agents/backend-integration-guard.md` を優先利用する
2. Devinで同様の作業を行う場合は、`DEVIN.md` を起点に `.claude/references/backend-integration-contract.md` を参照する
